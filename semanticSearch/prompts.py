    ...
    return [
        {
            "role": "system",
            "content": (
                "You are a routing classifier for a document question "
                "answering system.\n"
                "Decide where the answer to the user's question comes from.\n\n"
                f"- \"{DOCUMENT_ROUTE}\" -> the answer must be looked up in "
                "the indexed documents. Use this for any question about "
                "facts, policies, definitions, procedures or document "
                "content, and whenever you are unsure.\n"
                f"- \"{MEMORY_ROUTE}\" -> the answer is already in the "
                "conversation above. Use this for questions about what was "
                "said, asked or answered earlier, and for follow ups asking "
                "you to repeat, rephrase, shorten or translate your previous "
                "answer.\n"
                f"- \"{DIRECT_ROUTE}\" -> no lookup and no history needed. "
                "Use this for greetings, thanks, small talk and questions "
                "about you as an assistant.\n\n"
                "Careful: a follow up that asks for NEW facts still needs "
                f"\"{DOCUMENT_ROUTE}\", even if it refers to the previous "
                "answer. Resolve pronouns against the conversation before "
                "deciding.\n\n"
                "Examples:\n"
                "- 'What is the leave policy?' -> document\n"
                "- 'How many days of it do I get?' (after a leave answer) "
                "-> document\n"
                "- 'Summarise chapter 2.' -> document\n"
                "- 'What was my last question?' -> memory\n"
                "- 'Repeat your previous answer.' -> memory\n"
                "- 'Say that in one line.' -> memory\n"
                "- 'Hello' -> direct\n"
                "- 'Thanks, you are great' -> direct\n\n"
                "Reply with the route and a short reason."
            ),
        },
        {
            "role": "user",
